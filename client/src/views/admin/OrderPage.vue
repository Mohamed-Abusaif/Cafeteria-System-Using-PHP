  ...
  <div class="page-content">
    <div class="admin-orders-page">
      ...
      <div v-else>
        ...
        <!-- Table Section -->
        <div class="full-width-table px-3">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <p>You are updating the status of Order #{{ orderToUpdate?.id }}.</p>
              <p>
                Current status:
                <span
                  class="badge"
              ...
              <form @submit.prevent="updateOrderStatus">
                <div class="mb-3">
                  ...
                  <select class="form-select" id="newStatus" v-model="newStatus">
                    <option v-if="orderToUpdate?.status === 'processing'" value="delivered">
                      Delivered
                    </option>
